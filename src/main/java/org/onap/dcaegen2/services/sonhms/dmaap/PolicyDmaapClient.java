...
public class PolicyDmaapClient {
    ...
    public Boolean handlePolicyResponse(String requestId) {
        Configuration policyConfiguration = Configuration.getInstance();
        ...
        policyResponseCambriaConsumer = dmaapUtils.buildConsumer(policyConfiguration, policyResponseTopic);
        ...
        while (difference < 10000) {
            ...
            try {
                ...
                for (String msg : policyResponseMessages) {
                    ...
                    PolicyNotification policyResponse = new PolicyNotification();
                    policyResponse = mapper.readValue(msg, PolicyNotification.class);
